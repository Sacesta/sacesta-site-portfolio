...
export default function GlobeReviewsPage() {
  ...
  return (
    <div className="h-screen w-full bg-[#050505] text-white overflow-hidden relative" onClick={() => setSelectedReview(null)}>
        ...
        <AnimatePresence mode="wait">
          {activeReview && (
            <motion.div
              ...
              className={cn(
                "bg-[#0a0a0a]/60 backdrop-blur-3xl border p-7 rounded-[2.5rem] shadow-[0_30px_70px_rgba(0,0,0,0.7)] overflow-hidden relative pointer-events-auto",
                selectedReview ? "border-indigo-500/50" : "border-white/10"
              )}
              onClick={(e) => e.stopPropagation()}
            >
                  ...
                  <div className="flex flex-col gap-5 pt-5 border-t border-white/10">
                      <div className="flex items-center justify-between">
                          <div className="flex flex-col">
                              ...
                              <span className="text-white text-xs font-semibold tracking-tight leading-tight">{activeReview.projectName}</span>
                          </div>
                          <div className="flex gap-0.5">
                              ...
                              <Star
                                  key={i}
                                  className={cn(
                                  "w-3.5 h-3.5 text-indigo-500 fill-indigo-500 [filter:drop-shadow(0_0_5px_rgba(99,102,241,0.8))]"
                                  )}
                              />
                              ))}
                          </div>
